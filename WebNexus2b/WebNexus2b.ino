...
#define SAVE_INTERVAL 86400000 // 24 ore in millisecondi
...
void generateData() {
    ...
    for (int i = 0; i < MAX_DATA_POINTS; i++) {
        ...
        daysPoints[i].diff_a = random(1000, 10001);
...
void setup() {
    ...
    setTime(18, 0, 0, 1, 5, 2024); // Imposta la data e l'ora al 3 Giugno 2024, 18:00
    //generateData();
