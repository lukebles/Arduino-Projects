...
CenterHueSweep      centerRainbow(centerBus, CENTER_NLED, 10000, &g_centerPaused); // 10s
...
// Parametri individuali per le 5 strisce (copiati dal tuo codice originale)
...
// Esempio di “periodico ogni minuto”
void everyMinuteTask() {
  // esempio: piccola variazione di flicker sulle code
  ...
  // TRIGGER dell’arcobaleno sul centro
...
void setup() {
  ...
  centerEffect.attachPauseFlag(&g_centerPaused);   // <<< NEW
