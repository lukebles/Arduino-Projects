// LkRadioStructureEx.h

// Questa libreria usa VirtualWireEx anzichè VirtualWire
// affinchè possa essere usata su ESP01

//
// The LkRadioStructureEx library offers a streamlined and efficient way to transmit 
...
// control commands, or any custom data packets, LkRadioStructureEx handles the complexity 
// of data serialization and radio transmission, enabling developers to focus on 
// the core functionality of their applications.

// ===============================

// La libreria LkRadioStructureEx offre un modo semplificato ed efficiente per trasmettere 
...
// comandi di controllo o qualsiasi pacchetto di dati personalizzato, LkRadioStructureEx gestisce la complessità 
...
#ifndef LK_RADIOSTRUCTUREEX_H
#define LK_RADIOSTRUCTUREEX_H
