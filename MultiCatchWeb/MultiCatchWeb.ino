...
const int RX_PIN = 0;
const int TX_PIN = -1;
const int SEGNALATORE_ACUSTICO_PIN = 3;
...
void loop() {
  ...
  if (flash_datetime_not_set.expired()) {
      // il segnale non viene invertito perch su ESP01 è già invertito
    ...
    if (prevTime != 0) {
      ...
      if (activeDiff < 3600) {
        if (timeDiff < 3600000){
          ...
          //////////////////////////////////////////////////////////////////
          // qui occorre inserire il codice di WebNexus che riceve i dati
          // e li visualizza sulle pagine
          //////////////////////////////////////////////////////////////////
